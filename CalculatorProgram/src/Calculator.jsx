...
function Calculator() {
    ...
    <div className="calculatorFrame">
       ...
       <button value="C" onClick={() => handleButtonClick('C')}>C</button>
        ...
        <button id="divide" onClick={() => handleButtonClick('/')}>/</button><br></br>
        ...
        <button id="multiply" onClick={() => handleButtonClick('*')}>*</button><br></br>
        ...
        <button id="subtract" onClick={() => handleButtonClick('-')}>-</button><br></br>
        ...
        <button id="addition" onClick={() => handleButtonClick('+')}>+</button><br></br>
        <button id="zero" onClick={() => handleButtonClick('0')}>0</button>
        <button id="decimal" onClick={() => handleButtonClick('.')}>.</button>
        <button id="equalsBtn" onClick={() => handleButtonClick('=')}>=</button><br></br>
        </div>
        </div>
        </>
    );
